...
namespace Complain.Data
{
    ...
    public partial class Db_ComplaintModel : DbContext
    {
        ...
        private void VFormMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VForm>().Property(x => x.CostomerId).HasColumnName(@"Costomer_Id").HasColumnType(@"int").IsRequired().ValueGeneratedNever().HasPrecision(10, 0);
            ...
            modelBuilder.Entity<VForm>().Property(x => x.ProblemId).HasColumnName(@"Problem_Id").HasColumnType(@"int").IsRequired().ValueGeneratedNever().HasPrecision(10, 0);
            ...
            modelBuilder.Entity<VForm>().Property(x => x.EmpId).HasColumnName(@"Emp_Id").HasColumnType(@"int").IsRequired().ValueGeneratedNever().HasPrecision(10, 0);
        ...
        private void RelationshipsMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Form>().HasOne(x => x.TypeFrom).WithMany(op => op.Forms).IsRequired(false).HasForeignKey(@"TypeId");

            modelBuilder.Entity<TypeFrom>().HasMany(x => x.Forms).WithOne(op => op.TypeFrom).IsRequired(false).HasForeignKey(@"TypeId");
        }
