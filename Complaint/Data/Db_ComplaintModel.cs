...
namespace Complain.Data
{
    ...
    public partial class Db_ComplaintModel : DbContext
    {
        ...
        private void EmployeeMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Employee>().Property(x => x.EmpId).HasColumnName(@"Emp_Id").HasColumnType(@"nvarchar(50)").IsRequired().ValueGeneratedNever().HasMaxLength(50).HasPrecision(10, 0);
        ...
        private void FormMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Form>().Property(x => x.CostomerId).HasColumnName(@"Costomer_Id").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50).HasPrecision(10, 0);
            modelBuilder.Entity<Form>().Property(x => x.Lot).HasColumnName(@"lot").HasColumnType(@"date").ValueGeneratedNever();
            modelBuilder.Entity<Form>().Property(x => x.ProblemName).HasColumnName(@"Problem_name").HasColumnType(@"nvarchar(max)").ValueGeneratedNever();
            ...
            modelBuilder.Entity<Form>().Property(x => x.TypeName).HasColumnName(@"Type_name").HasColumnType(@"nvarchar(50)").ValueGeneratedNever().HasMaxLength(50);
        ...
        private void TypeFromMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<TypeFrom>().Property(x => x.TypeId).HasColumnName(@"Type_Id").HasColumnType(@"nvarchar(50)").IsRequired().ValueGeneratedNever().HasMaxLength(50).HasPrecision(10, 0);
        ...
        private void VFormMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<VForm>().Property(x => x.CostomerId).HasColumnName(@"Costomer_Id").HasColumnType(@"nvarchar(50)").IsRequired().ValueGeneratedNever().HasMaxLength(50).HasPrecision(10, 0);
            ...
            modelBuilder.Entity<VForm>().Property(x => x.ProductId).HasColumnName(@"Product_Id").HasColumnType(@"nvarchar(50)").IsRequired().ValueGeneratedNever().HasMaxLength(50);
            ...
            modelBuilder.Entity<VForm>().Property(x => x.ProblemId).HasColumnName(@"Problem_Id").HasColumnType(@"nvarchar(50)").IsRequired().ValueGeneratedNever().HasMaxLength(50).HasPrecision(10, 0);
            ...
            modelBuilder.Entity<VForm>().Property(x => x.TypeId).HasColumnName(@"Type_Id").HasColumnType(@"int").IsRequired().ValueGeneratedNever().HasPrecision(10, 0);
            ...
            modelBuilder.Entity<VForm>().Property(x => x.EmpId).HasColumnName(@"Emp_Id").HasColumnType(@"nvarchar(50)").IsRequired().ValueGeneratedNever().HasMaxLength(50).HasPrecision(10, 0);
            ...
            modelBuilder.Entity<VForm>().Property(x => x.DepartmentId).HasColumnName(@"department_Id").HasColumnType(@"int").IsRequired().ValueGeneratedNever().HasPrecision(10, 0);
            ...
            modelBuilder.Entity<VForm>().Property(x => x.SectionId).HasColumnName(@"section_Id").HasColumnType(@"int").IsRequired().ValueGeneratedNever().HasPrecision(10, 0);
            ...
            modelBuilder.Entity<VForm>().Property(x => x.PositionId).HasColumnName(@"position_Id").HasColumnType(@"int").IsRequired().ValueGeneratedNever().HasPrecision(10, 0);
            ...
            modelBuilder.Entity<VForm>().Property(x => x.MngId).HasColumnName(@"Mng_Id").HasColumnType(@"int").IsRequired().ValueGeneratedNever().HasPrecision(10, 0);
            ...
            modelBuilder.Entity<VForm>().Property(x => x.Expr1).HasColumnName(@"Expr1").HasColumnType(@"nvarchar(max)").ValueGeneratedNever();
        ...
        {
            modelBuilder.Entity<Costomer>().HasMany(x => x.Forms).WithOne(op => op.Costomer).IsRequired(false).HasForeignKey(@"CostomerId");

            modelBuilder.Entity<Form>().HasOne(x => x.Costomer).WithMany(op => op.Forms).IsRequired(false).HasForeignKey(@"CostomerId");
            modelBuilder.Entity<Form>().HasOne(x => x.Form_FromId1).WithOne(op => op.Form_FromId).IsRequired(true).HasForeignKey(typeof(Form), @"FromId");
            modelBuilder.Entity<Form>().HasOne(x => x.Form_FromId).WithOne(op => op.Form_FromId1).IsRequired(true).HasForeignKey(typeof(Form), @"FromId");
            modelBuilder.Entity<Form>().HasOne(x => x.TypeFrom).WithMany(op => op.Forms).IsRequired(false).HasForeignKey(@"TypeName");

            modelBuilder.Entity<TypeFrom>().HasMany(x => x.Forms).WithOne(op => op.TypeFrom).IsRequired(false).HasForeignKey(@"TypeName");
        }
